...
<!--ts-->
   * [О компиляторе](#О-компиляторе)
	  ...
	  * [Синтаксический анализ](#Синтаксический-анализ)
		...
		* [AST дерево](#Абстрактное-синтаксическое-дерево)
...
```
При групповой инициализации нельзя указывать тип переменных. Тип определяется автоматически.
##### Объявление массива
``` rust
...
- Проверка на соответствие числа элементов групповой инициализации
